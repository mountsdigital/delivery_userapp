...
import com.mounts.lenovo.delivery3.adapter.FieldSelector;
import com.mounts.lenovo.delivery3.adapter.StringUtil;
...
public class AutocompleteTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Places.initialize(getApplicationContext(), "AIzaSyAUO8UWsv35NdyGN8A0tql7gIEjUi0FVys");
